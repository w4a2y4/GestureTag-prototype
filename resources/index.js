...
const swipeImages = {
    ...
    // up: img_prefix + 'icon1_up.png',
    // down: img_prefix + 'icon1_down.png',
    // left: img_prefix + 'icon1_left.png',
    // right: img_prefix + 'icon1_right.png',
    // up: img_prefix + 'icon2_up.png',
    // down: img_prefix + 'icon2_down.png',
    // left: img_prefix + 'icon2_left.png',
    // right: img_prefix + 'icon2_right.png',
    up: img_prefix + 'icon3_up.png',
    down: img_prefix + 'icon3_down.png',
    left: img_prefix + 'icon3_left.png',
    right: img_prefix + 'icon3_right.png',
    // up: img_prefix + 'icon4_up.png',
    // down: img_prefix + 'icon4_down.png',
    // left: img_prefix + 'icon4_left.png',
    // right: img_prefix + 'icon4_right.png',
};
const tapImages = {
